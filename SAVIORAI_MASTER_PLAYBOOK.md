# SaviorAI — Complete Master Playbook
...
**One-line pitch:** "One student dies by suicide every 40 minutes in India. SaviorAI is the autonomous agent that watches what counsellors can't — 24/7, at scale, before the crisis."
...
async def whatsapp_webhook(
    ...
    if not student:
        return send_whatsapp(phone, "Welcome to SaviorAI. Please register with your institution.")
...
**SETUP:** Dashboard open on laptop. Phone on table with SaviorAI PWA installed.
...
**1:35** — Final line: *"One student dies by suicide every 40 minutes in India. SaviorAI doesn't replace counsellors. It makes sure no student reaches that minute without someone already knowing."*

---

## SECTION 10 — VIBE CODING STRATEGY

### The 5 Commandments of Vibe Coding SaviorAI
...
```
I am building SaviorAI — an autonomous student mental health triage agent 
...
```
Context: Building SaviorAI backend. 
...
```
Context: Building the core AI component of SaviorAI.
...
```
Context: Building SaviorAI. HMM engine is complete and tested.
...
```
Context: Building SaviorAI. All agent components complete.
...
```
Context: Building SaviorAI. Backend pipeline complete.
...
```
Context: Building SaviorAI demo. Backend routes complete.
...
```
Context: Building SaviorAI frontend. Backend complete and tested.
...
- Show "SaviorAI is watching" notification when installed
...
```
Context: SaviorAI is complete. Need demo-ready automation.
...
```
Context: SaviorAI is complete and demo-ready.

Task: Create a competition-grade GitHub README.md

Structure:
1. Header: Logo (use live vector graphics), title "SaviorAI", tagline
...
*"Wysa and YourDOST are reactive tools — students go to them when they already know they need help. The student in crisis at 2am is not opening Wysa. SaviorAI is proactive — it finds students before they reach out, including students who are masking their distress. The adversarial validator and cohort detector don't exist in any consumer mental health app. That's the differentiation."*

**"What is your false negative rate?"**
*"We don't claim zero false negatives — that would be dishonest. A student determined to mask their feelings can evade any system. That's why SaviorAI is a support layer for counsellors, not a replacement for human relationships. Our adversarial validator is specifically designed to flag likely masking cases for direct human outreach. The system is designed to be honest about its own limitations."*
